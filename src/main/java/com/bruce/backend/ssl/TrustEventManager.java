...
public class TrustEventManager implements X509TrustManager {

    protected TrustEventListener checker;

    public TrustEventManager(TrustEventListener trustEventListener) {
        this.checker = trustEventListener;
    }
